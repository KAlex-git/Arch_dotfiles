...
config.bind(',p', 'spawn --userscript qute-pass --dmenu-invocation "wofi -d" --username-target secret --username-pattern "[Uu]sername: (.+)"')
config.bind(',P', 'spawn --userscript qute-pass --dmenu-invocation "wofi -d" --username-target secret --username-pattern "[Uu]sername: (.+)" --password-only')
