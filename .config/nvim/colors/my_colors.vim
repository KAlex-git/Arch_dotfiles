hi clear
syntax reset
let g:colors_name = "my_colors-vim"
set background=dark
set t_Co=256
hi Normal guifg=#00ff00 ctermbg=NONE guibg=#000000 gui=NONE
...
hi NonText guifg=#9b9b9b guibg=#000000
hi Comment guifg=#9b9b9b gui=italic
hi SpecialComment guifg=#9b9b9b gui=italic guibg=#000000
...
hi Search guibg=#9b9b9b guifg=#ffffff
